...
diretorioCSV = "C:\\leosbrito\\projetos\\testev\\convertedbf\\csv"
...
def converter_dbc2dbf(arquivo_dbc):
    try:
        print("#####################################################")
...
for arquivo_dbc in os.listdir(diretorioDBC):
    if arquivo_dbc.endswith(".dbc"):
        ...
        if ultimo_arquivo_dbf:
            ...
            converter_parquet2csv(ultimo_arquivo_dbf)
        else:
